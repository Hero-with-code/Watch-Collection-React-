...
const ImageList = [
  {
    ...
    price: "15.50",
    tag: "New",
    title: "OnePlus Smart Watch Blue ",
    description:
      "The OnePlus Watch is a sleek, feature-packed smartwatch offering fitness tracking, heart rate monitoring, sleep analysis, and up to 14 days of battery life. It pairs seamlessly with OnePlus smartphones and supports customizable watch faces and notifications.",
  },
  {
    id: 2,
    img: watch2,
    price: "13.50",
    tag: "Sale",
    title: "Best & Smart Watch Boat Yellow ",
    description:
      "The boAt Smartwatch offers a blend of style and functionality with features like fitness tracking, heart rate monitoring, SpO2 tracking, sleep analysis, and long-lasting battery life. It supports notifications, customizable watch faces, and is water-resistant, making it ideal for active users.",
  },
  {
    id: 3,
    img: watch3,
    ...
    description:
      "The Apple Watch Ultra is a rugged, high-performance smartwatch designed for outdoor enthusiasts. It features a titanium case, larger display, advanced GPS, deep dive capabilities, health tracking, and up to 36 hours of battery life, combining durability with smart features.",
  },
];
